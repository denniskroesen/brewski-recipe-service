...
public abstract class GeneratedRecipeStepsController {
    
    protected @Autowired BrewskiBackendApplication app;
    protected @Autowired RecipeStepsManager manager;
    
    @RequestMapping(value = "/recipeSteps", method = GET)
    public List<RecipeSteps> get(@RequestParam(value = "start", defaultValue = "0") long start,
